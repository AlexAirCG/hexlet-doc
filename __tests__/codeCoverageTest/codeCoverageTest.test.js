import getImpelementation from '../../src/codeCoverageTest/index.js'
...
test('testing function slice()', () => {
  ...
  const actual3 = slice([1, 2, 3, 4, 5], -8, 8)
  expect(actual3).toEqual([1, 2, 3, 4, 5])
...
test('testing function indexOf()', () => {
  ...
  // BEGIN (write your solution here)
  const actual2 = indexOf([], 1)
  expect(actual2).toBe(-1)

  const actual3 = indexOf([1, 2, 3, 2, 5], 2, -3)
  expect(actual3).toBe(3)

  const actual4 = indexOf([1, 2, 3, 2, 5], 2, -10)
