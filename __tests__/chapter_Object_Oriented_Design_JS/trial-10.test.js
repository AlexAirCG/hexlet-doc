...
import Enumerable from '../../src/chapter_Object_Oriented_Design_JS/trial-10.js'
...
describe('default', () => {
  ...
  test('multiple where', () => {
    ...
    const expected1 = [{ key: 'value2', year: 32 }]
    expect(result1.all()).toEqual(expected1)
    expect(coll.all()).toEqual(elements)
  })
})
...
describe('memoization', () => {
  ...
  test('multiple where', () => {
    ...
    const expected1 = [{ key: 'value2', year: 32 }]
    expect(result1.allWithMemoization()).toEqual(expected1)
  })
})
